    ...
    return (
        <section className="flex flex-row items-center justify-center md:gap-x-9 px-12 sm:px-56 pt-12 sm:pt-10 md:pt-24">
            <div className="relative md:static md:block">
                ...
                <h1 className="text-7xl leading-relaxed underline decoration-zinc-300 dark:decoration-zinc-500">
            ...
            <img
                ...
                className="absolute -z-40 opacity-30 inset-0 h-screen md:opacity-100 md:z-0 md:static md:h-80 md:rounded-3xl"
            />
        </section>
    );
};
